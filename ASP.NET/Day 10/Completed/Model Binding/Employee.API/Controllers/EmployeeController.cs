using Employee.API.ModelBinders;
...
namespace Employee.API.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public ActionResult<EmployeeEntity> Post([ModelBinder(BinderType = typeof(EmployeeModelBinder))] [FromForm] EmployeeEntity Employee)
        {
